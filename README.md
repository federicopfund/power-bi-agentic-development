...
| [`standardize-naming-conventions`](plugins/tabular-editor/skills/standardize-naming-conventions/) | tabular-editor | Audit and standardize naming conventions in TMDL semantic models |
